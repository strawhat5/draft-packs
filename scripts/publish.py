...
for i in langs:
    ...
    copyfile("./lang/charts/templates/deployment-canary.yaml", "../packs/" + i + "/charts/templates/deployment-canary.yaml")
    copyfile("./lang/charts/templates/deployment-green.yaml", "../packs/" + i + "/charts/templates/deployment-green.yaml")
    copyfile("./lang/charts/templates/deployment.yaml", "../packs/" + i + "/charts/templates/deployment.yaml")
    copyfile("./lang/charts/templates/external-name.yaml", "../packs/" + i + "/charts/templates/external-name.yaml")
    copyfile("./lang/charts/templates/ingress-green.yaml", "../packs/" + i + "/charts/templates/ingress-green.yaml")
    copyfile("./lang/charts/templates/ingress.yaml", "../packs/" + i + "/charts/templates/ingress.yaml")
    copyfile("./lang/charts/templates/mapping.yaml", "../packs/" + i + "/charts/templates/mapping.yaml")
    copyfile("./lang/charts/templates/service-green.yaml", "../packs/" + i + "/charts/templates/service-green.yaml")
